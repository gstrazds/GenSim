...
class ColorCoordinatedCylinderOnBlock(RobotScript):
    """Place colored cylinders onto the matching colored boxes in a specific sequence."""
    ...
    def act(self, obs, info):
        ''' Each time this method is invoked, move the next cylinder in the sequence onto the matching colored box.
        '''
